					     ...
					     struct drm_atomic_commit *state)
{
	...
	/*
	 * VPU_HDMI_FMT_CTRL: [1:0] chroma format (0 = 444, 1 = 422, 2 = 420),
	 * [3:2] chroma downsampling (2 = average), [4] 12 to 10-bit dither,
	 * [10] 12 to 10-bit rounding.
	 * VPU_HDMI_DITH_CNTL: [4] 10 to 8-bit dither, [3:2] sync flags.
	 */
	depth = meson_encoder_hdmi_fmt_depth(encoder_hdmi->output_bus_fmt);
